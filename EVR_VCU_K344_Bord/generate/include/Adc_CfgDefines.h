...
*/
#define AdcChannel_Accel1                       (0x0U)
#define AdcChannel_Accel2                       (0x1U)
#define AdcChannel_Brake                       (0x1000U)
...
#define AdcGroup_Acceleration1                                (0U)
#define AdcGroup_Acceleration2                                (1U)
#define AdcGroup_Brake                                (2U)

/**
* @brief           Symbolic names of groups - ecuc 2108 compliant.
*/

#define AdcConf_AdcGroup_AdcGroup_Acceleration1               (0U)
#define AdcConf_AdcGroup_AdcGroup_Acceleration2               (1U)
#define AdcConf_AdcGroup_AdcGroup_Brake               (2U)
