...
*/
#define SpiConf_SpiChannel_SpiChannel_FS26    ((Spi_ChannelType)0U)
#define SpiConf_SpiChannel_SpiChannel_Display    ((Spi_ChannelType)1U)
...
*     for all the driver configurations.
*/
#define SpiConf_SpiJob_SpiJob_FS26    ((Spi_JobType)0U)
#define SpiConf_SpiJob_SpiJob_Display    ((Spi_JobType)1U)
...
*     for all the driver configurations.
*/
#define SpiConf_SpiSequence_SpiSequence_FS26    ((Spi_SequenceType)0U)
#define SpiConf_SpiSequence_SpiSequence_Display    ((Spi_SequenceType)1U)
...
*/
#define SPI_SpiExternalDevice_FS26  ((Spi_ExternalDeviceType)0u)
#define SPI_SpiExternalDevice_Display  ((Spi_ExternalDeviceType)1u)
