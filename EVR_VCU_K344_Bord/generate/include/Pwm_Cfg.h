...
*
*/
#define PwmChannel_DAC_A                            ((Pwm_ChannelType)0U)
#define PwmChannel_DAC_B                            ((Pwm_ChannelType)1U)

/**
* @brief        Symbolic name for configured channels - TPS_ECUC_02108 compliant.
*
*/
#define PwmConf_PwmChannel_PwmChannel_DAC_A          ((Pwm_ChannelType)0U)
#define PwmConf_PwmChannel_PwmChannel_DAC_B          ((Pwm_ChannelType)1U)
