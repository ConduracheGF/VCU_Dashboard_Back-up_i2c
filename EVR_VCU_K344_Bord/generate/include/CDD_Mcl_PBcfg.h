...
extern const Mcl_EmiosInstanceConfigType Mcl_EmiosInstanceConfig_BOARD_INITPERIPHERALS[1U];

/* EMIOS sturcture used for intialization. */
extern const Mcl_EmiosInitConfigType Mcl_EmiosConfig_BOARD_INITPERIPHERALS;
