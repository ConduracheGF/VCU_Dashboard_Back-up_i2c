...
#define EMIOS_PWM_IP_PB_CFG_SW_MAJOR_VERSION_C                4
...
/* Emios PWM mode configuration structure for PwmEmios_0/PwmEmiosChannels_DAC_A */
...
/* Emios PWM mode configuration structure for PwmEmios_0/PwmEmiosChannels_DAC_B */
const Emios_Pwm_Ip_ChannelConfigType Emios_Pwm_Ip_I0_Ch4 =
{
    /* .ChannelId */            4U,
    /* .Mode */                 EMIOS_PWM_IP_MODE_OPWFMB_FLAG,
    /* .Timebase */             EMIOS_PWM_IP_BUS_INTERNAL,
