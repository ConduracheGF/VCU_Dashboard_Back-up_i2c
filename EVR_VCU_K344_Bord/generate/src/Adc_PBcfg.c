...
#define ADC_SW_MAJOR_VERSION_PBCFG_C             4
...
/**
* @brief          Group Assignments on ADC2 .
*
*/
static const Adc_ChannelType Adc_Group0_Assignment_2[ADC_CFGSET_GROUP_0_CHANNELS] =
{
    0U
};
...
*
*/
static const Adc_ChannelType Adc_Group1_Assignment_2[ADC_CFGSET_GROUP_1_CHANNELS] =
{
    1U
};
...
{
    /**< @brief Group0 -- Logical Unit Id 0 -- Hardware Unit ADC2 */
    {
        ...
        Adc_Group0_Assignment_2, /* AssignmentPtr */
    ...
    /**< @brief Group1 -- Logical Unit Id 0 -- Hardware Unit ADC2 */
    {
        /**< @brief Index of group */
        1U, /* GroupId */
        /**< @brief ADC Logical Unit Id that the group belongs to */
...
#endif /* (ADC_ENABLE_GROUP_STREAMING_RESULTS_REORDER == STD_ON) */
        /**< @brief Channels assigned to the group*/
        Adc_Group1_Assignment_2, /* AssignmentPtr */
        /**< @brief Number of channels in the group*/
    ...
    /**< @brief Group2 -- Logical Unit Id 1 -- Hardware Unit ADC0 */
    {
        /**< @brief Index of group */
        2U, /* GroupId */
        /**< @brief ADC Logical Unit Id that the group belongs to */
