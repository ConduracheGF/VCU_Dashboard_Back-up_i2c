...
#define LPSPI_IP_SW_MAJOR_VERSION_PBCFG_C                 4
...
#include "Spi_MemMap.h"
/* Lpspi_Ip_DeviceAttributes_SpiExternalDevice_FS26 Device Attribute Configuration of Spi*/
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_FS26_Instance_3 =
{
    3U,  /* Instance */
...
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_Display_Instance_4 =
{
    4U,  /* Instance */
    (uint32)(LPSPI_CFGR0_HRDIR(0u) | LPSPI_CFGR0_HREN(0u) |
             LPSPI_CFGR0_HRSEL(0u) | LPSPI_CFGR0_HRPOL(0u)), /* CFGR0 */
        (uint32)(LPSPI_CCR_SCKPCS(39U) | LPSPI_CCR_PCSSCK(39U) | LPSPI_CCR_SCKDIV(2U) | LPSPI_CCR_DBT(38U)), /* ccr */
...
const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_1_Instance_4 =
{
    4U,  /* Instance */
     /* CR */
    (uint32)0,
