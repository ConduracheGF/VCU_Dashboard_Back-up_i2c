...
#define SPI_IPW_SW_MAJOR_VERSION_PBCFG_C                 4
...
#include "Spi_MemMap.h"
/* External device configuration for SpiExternalDevice_FS26 */
static const Spi_ExternalDeviceConfigType Spi_ExternalDeviceConfig_SpiExternalDevice_FS26 =
{
    SPI_OVER_LPSPI, /* IpType */
    3U,  /* Instance */
    {   /* ExternalDeviceConfig */
        &Lpspi_Ip_DeviceAttributes_SpiExternalDevice_FS26_Instance_3, /* Lpspi IP Config */
...
static const Spi_ExternalDeviceConfigType Spi_ExternalDeviceConfig_SpiExternalDevice_Display =
{
    SPI_OVER_LPSPI, /* IpType */
    4U,  /* Instance */
    {   /* ExternalDeviceConfig */
        &Lpspi_Ip_DeviceAttributes_SpiExternalDevice_Display_Instance_4, /* Lpspi IP Config */
        #if (SPI_IPW_SPI_FLEXIO_ENABLE == STD_ON)
        NULL_PTR /* Flexio_Spi IP Config */
        #endif
    },
...
{
    /* SpiExternalDevice_FS26 */
    {
        &Spi_ExternalDeviceConfig_SpiExternalDevice_FS26
    },
    /* SpiExternalDevice_Display */
    {
        &Spi_ExternalDeviceConfig_SpiExternalDevice_Display
    }
};
...
static const Spi_HWUnitConfigType Spi_HwUnitConfig_SpiPhyUnit_0 =
{
        ...
        {
            &Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_0_Instance_3 /* Lpspi IpConfig */
            #if (SPI_IPW_SPI_FLEXIO_ENABLE == STD_ON)
...
static const Spi_HWUnitConfigType Spi_HwUnitConfig_SpiPhyUnit_1 =
{
        ...
        SPI_SPURIOUS_CORE_ID_U32, /* Core Id */
        {
            &Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_1_Instance_4 /* Lpspi IpConfig */
            #if (SPI_IPW_SPI_FLEXIO_ENABLE == STD_ON)
            ,NULL_PTR /* Flexio_Spi IpConfig */
            #endif
            #if ((LPSPI_IP_DMA_USED == STD_ON) && (LPSPI_IP_ENABLE_DMAFASTTRANSFER_SUPPORT == STD_ON))
