...
#define ADC_SAR_IP_SW_MAJOR_VERSION_PBCFG_C              4
...
/**
* @brief          ADC SAR Ip List of Channels Configuration for Logical ID 0 corresponding to the ADC2 configuration variant  .
*/
...
/**
* @brief          ADC SAR Ip List of Channels Configuration for Logical ID 1 corresponding to the ADC0 configuration variant  .
*/
...
/**
* @brief          ADC SAR Ip Config for Logical ID 0 corresponding to the ADC2 configuration variant  .
*/
...
/**
* @brief          ADC SAR Ip Config for Logical ID 1 corresponding to the ADC0 configuration variant  .
*/
