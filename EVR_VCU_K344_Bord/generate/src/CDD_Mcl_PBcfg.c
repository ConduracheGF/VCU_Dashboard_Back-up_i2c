...
#define CDD_MCL_BOARD_InitPeripherals_PBCFG_SW_MAJOR_VERSION_C              4
...
const Mcl_ConfigType Mcl_Config =
{
	...
	NULL_PTR,
	NULL_PTR,
	&Mcl_EmiosConfig_BOARD_INITPERIPHERALS,
	NULL_PTR,
};
...
*/
const Mcl_EmiosInstanceConfigType Mcl_EmiosInstanceConfig_BOARD_INITPERIPHERALS[1U] =
{
    {
...
*          part configurated using Mcl driver
*/
const Mcl_EmiosInitConfigType Mcl_EmiosConfig_BOARD_INITPERIPHERALS =
{
    /** @brief  Number of EMIOS instaces to configure. */
    (uint8)1,
    /** @brief  Address of the EMIOS instances configuration. */
    &Mcl_EmiosInstanceConfig_BOARD_INITPERIPHERALS
};
